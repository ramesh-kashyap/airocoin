...
// add fund
  Route::get('/fund_transfer', [App\Http\Controllers\UserPanel\AddFund::class, 'fund_transfer'])->name('user.fund_transfer');
    Route::get('/addfund', [App\Http\Controllers\UserPanel\AddFund::class, 'transfer_fund'])->name('user.addfund');
...
Route::post('/fund', [App\Http\Controllers\UserPanel\AddFund::class, 'fund'])->name('user.fund');
Route::get('/fundconfirm', [App\Http\Controllers\UserPanel\AddFund::class, 'fundconfirm'])->name('user.fundconfirm');


Route::get('/fundHistory', [App\Http\Controllers\UserPanel\AddFund::class, 'fundHistory'])->name('user.fundHistory');
Route::get('/transferfundhistory', [App\Http\Controllers\UserPanel\AddFund::class, 'transferfundhistory'])->name('user.transferfundhistory');
...
Route::get('/airoinvest', [App\Http\Controllers\UserPanel\Invest::class, 'airoinvest'])->name('user.airoinvest');
...
Route::get('/direct-bonus', [App\Http\Controllers\UserPanel\Bonus::class, 'cashback_income'])->name('user.direct-bonus');
...
Route::get('direct-bonus', [App\Http\Controllers\Admin\BonusController::class, 'reward_bonus'])->name('admin.direct-bonus');
...
Route::get('solanaWithdraw', [App\Http\Controllers\Admin\WithdrawController::class, 'solanaWithdraw'])->name('admin.solanaWithdraw');
