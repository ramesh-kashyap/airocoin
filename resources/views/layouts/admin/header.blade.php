...
<body>
    ...
    ***********************************-->
    ...
    <img src="{{ asset('frontend\img\user_logo.png') }}" class="logo" alt=""/>
                ...
                <!--</li>-->
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{route('admin.direct-bonus')}}">Direct Bonus</a></li>
                    ...
                    <li><a href="{{route('admin.solanaWithdraw')}}">Solana Withdrawal</a></li>
