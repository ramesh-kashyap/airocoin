        ...
        <form action="" method="post" id="form_dep" class="invest__form">
                ...
                <div class="drop-down">
                    ...
                    <ul>
                        ...
                        <li class="for-load" onclick="set_type(1)">
                            <p>
                                <img class="icon-svg" src="{{asset('')}}frontend/img/cabinet/crypto/bep.png" alt="icon-crypto">
            ...
            <div class="invest__line">
                ...
                <div class="bg-input abbreviation small">
                    <input type="text" name="value_crypto"  id="value_crypto" value="100" placeholder="">
